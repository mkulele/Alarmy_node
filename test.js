...
var serverKey = 'AAAA6L8paoQ:APA91bGs5aJ-eGXzd6QBKEICxqIWEKcAQXEvUxO0um-bhTavrBGYV32SCbjxJmazcgdaFa7pYYrxa_UAnNBQ52KtKCamk6qQqTjeWzlj5EcI420C2GRHrKDbv3GKwaSfnuGGO4fi4YmB';

/** 안드로이드 단말에서 추출한 token값 */
// 안드로이드 App이 적절한 구현절차를 통해서 생성해야 하는 값이다.
// 안드로이드 단말에서 Node server로 POST방식 전송 후,
// Node서버는 이 값을 DB에 보관하고 있으면 된다.
var client_token = FirebaseInstanceId.getInstance().getToken();
/** 발송할 Push 메시지 내용 */
var push_data = {
    // 수신대상
    to: client_token,
